...
vc = cv2.VideoCapture('./video/test4.avi')
...
for i in range(0, length):
    ...
    if iteration_first == 1:
        ...
        cv2.imwrite('./diff/frame.jpg', fr)
        cv2.imwrite('./diff/diff-frame.jpg', filt)
        ...
        cv2.imwrite('/diff/mask.jpg', mhi_image)
...
bar.finish()
create_video('frames/', './video/output.avi')
...
cv2.imwrite('/diff/diff-overlay.jpg', result_overlay)
# cleanup
vc.release()
